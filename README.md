...
- List, search, create, and resume persistent Harness sessions ordered by server activity
- Show server-authoritative running, finished, unread, and read session states
