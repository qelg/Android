...
- Show server-authoritative running, finished, unread, read, and archived session states; refresh the overview from one snapshot and poll incremental session updates every five seconds while active
